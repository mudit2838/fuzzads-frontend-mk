...
export default Login;      // Token & user ko hamesha localStorage mein save karo
      // (refresh survive karega, tab close par logout ho jayega logout button se)
      localStorage.setItem('token', token);
      localStorage.setItem('user', JSON.stringify(userData));

      // Optional: agar "Remember me" unchecked hai to tab close par logout feel ke liye
      // sessionStorage mein bhi save kar sakte ho, par abhi simple rakha
